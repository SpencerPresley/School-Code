...
//        	cout << endl << j << " " << locMax << endl << arr[j] << " " << arr[locMax] << endl;
// 		another line of code intended for me to test, left here for convenience of others to activate it to look what's happening  
	  swap(arr[j], arr[locMax]); // swaps max value to correct location, this swap always happens  
